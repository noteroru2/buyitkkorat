...
const out = "docs/batch-1-critical-protection-2026-08-05/screenshots";
...
for (const viewport of [
  ...
  // cookie banner explicit capture on mobile home
  if (viewport.label === "390") {
    ...
    await page.click('[data-cookie-action="deny"]');
    await page.waitForTimeout(300);
    await page.screenshot({ path: path.join(out, "home-cookie-denied-390.png") });
  }
  await context.close();
}
await browser.close();
